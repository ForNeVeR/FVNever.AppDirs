...
(Feel free to attribute the changes to "FVNever.AppDirs contributors <https://github.com/ForNeVeR/FVNever.AppDirs>" instead of your name in a multi-author file, or if you don't want your name to be mentioned in the project's source: this doesn't mean you'll lose the copyright.)
