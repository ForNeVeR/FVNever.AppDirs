...
3. Update the existing or create a new key named `ForNeVeR.FVNever.AppDirs.github` with a permission to **Push only new package versions** and only allowed to publish the package **FVNever.AppDirs**.
